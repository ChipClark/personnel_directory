...
const routes: Routes = [
  ...
  { path: 'people/Los%20Angeles', component: LosAngelesComponent },
  { path: 'people/Century%20City', component: CenturyCityComponent },
  { path: 'people/San%20Diego', component: SanDiegoComponent },
  { path: 'people/San%20Franciso', component: SanFranciscoComponent },
  { path: 'people/Orange%20Country', component: OrangeCountyComponent },
